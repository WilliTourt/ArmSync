...
### Tool List
- Hex key set / Screwdriver set (electric drill or electric screwdriver recommended)

### Parts Check
Before assembly, verify all parts against the [Parts BOM](./Parts%20BOM.md).
...
3. **Install Motor**
   - Insert 57 stepper motor shaft into gearbox input shaft. There is a fastening screw on the gearbox input end — make sure it is fully tightened.
...
- Locking Bushing Z21 14×26×17 × 1 (not recommended)
- Diaphragm Coupling D32d14 L28 × 1 (recommended) **Note: The coupling needs to be disassembled into two halves. Use one half's shaft bore and its end flange to connect the structural part and shaft.**
...
1. **Connect J1 and J2**
   ...
   - Connect using locking bushing or coupling. Screws must be tightened very firmly to ensure secure fastening.
   - **Note: This is the critical load-bearing joint of the entire arm — tighten securely.**
...
The assembly process for the remaining joints is similar to the one described above. Just pay attention to the 42 motor model and screw lengths. Below are assembly diagrams for each joint:
...
**Parts Required:**
- 2GT 20T Timing Pulleys × 2
- H3M 25T Timing Pulleys × 4
- 128-2GT-6 Timing Belt × 1
- H3M Timing Belt 162-H3M-10 × 1
- H3M Timing Belt 162-H3M-15 × 1

**Assembly Procedure:**

1. **Install Shaft**
   - Clamp the 5mm metal shaft to the gearbox input end where timing pulley needs to be installed.

2. **Assemble Timing Pulleys/Belts**
   - Pre-assemble timing pulleys with corresponding timing belts, then slide both pulleys simultaneously onto motor shaft and gearbox shaft.
   - Ensure timing pulley teeth always mesh with timing belt teeth.
   - Fasten timing pulleys to shafts, ensure they are parallel.

**Note: Timing belt tension needs to be adjusted by fine-tuning the center distance between motor and gearbox shafts. Be careful not to over-tension the timing belts during adjustment.**
