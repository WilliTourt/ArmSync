...
{
    q_zero.w = eskf.get_qw();
    q_zero.x = eskf.get_qx();
    q_zero.y = eskf.get_qy();
    q_zero.z = eskf.get_qz();
...
void initializeSensors(void)
{
    ...
    res_general_icm42688 = icm42688.general.enable_acc(ICM42688::General::ACCEL_ODR::ACCEL_ODR_50HZ, 
                               ICM42688::General::ACCEL_FS::ACCEL_FS_4G, 
...
void cpp_main(void) 
{
    ...
    while(1) {   
        if(main_timer_call == true) {
        ...
        #ifdef BigArm    // 大臂程序
            q_upper.w = eskf.get_qw();
            q_upper.x = eskf.get_qx();
            q_upper.y = eskf.get_qy();
            q_upper.z = eskf.get_qz();
            ...
            q_fore.w = eskf.get_qw();
            q_fore.x = eskf.get_qx();
            q_fore.y = eskf.get_qy();
            q_fore.z = eskf.get_qz();
