...
gpt_instance_ctrl_t g_timer_buzzer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_buzzer_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_timer_buzzer_extend =
{
...
#if 0
    .p_pwm_cfg             = &g_timer_buzzer_pwm_extend,
#else
    .p_pwm_cfg             = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_buzzer_cfg =
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.000370359375 seconds. Actual duty: 49.99789056237607%. */ .period_counts = (uint32_t) 0x5c97, .duty_cycle_counts = 0x2e4b, .source_div = (timer_source_div_t)0,
    .channel             = 1,
    .p_callback          = NULL,
    ...
    .p_context           = (void *) &NULL,
#endif
    .p_extend            = &g_timer_buzzer_extend,
...
const timer_instance_t g_timer_buzzer =
{
    .p_ctrl        = &g_timer_buzzer_ctrl,
    .p_cfg         = &g_timer_buzzer_cfg,
...
{
    .scan_mask           = ADC_MASK_CHANNEL_0 | ADC_MASK_CHANNEL_9 |  0,
    .scan_mask_group_b   =  0,
...
const timer_cfg_t g_timer_main_cfg =
{
    ...
    .channel             = 0,
    .p_callback          = Timer_Main_Callback,
    /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
sci_uart_instance_ctrl_t     g_uart2_ctrl;
            ...
            {
                /* Baud rate calculated with 0.644% error. */ .semr_baudrate_bits_b.abcse = 1, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 0, .cks = 0, .brr = 45, .mddr = (uint8_t) 256, .semr_baudrate_bits_b.brme = false
            };
