/* Manual solver_base.h — vtable for base solver */
...
IK_PRIVATE_API void ik_solver_base_iterate_all_nodes(struct ik_solver_t* solver, ik_solver_iterate_node_cb_func cb);
IK_PRIVATE_API void ik_solver_base_iterate_affected_nodes(struct ik_solver_t* solver, ik_solver_iterate_node_cb_func cb);
IK_PRIVATE_API void ik_solver_base_iterate_base_nodes(struct ik_solver_t* solver, ik_solver_iterate_node_cb_func cb);
