...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_NUM_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [5] = sci_b_uart_rxi_isr, /* SCI4 RXI (Receive data full) */
            [6] = sci_b_uart_txi_isr, /* SCI4 TXI (Transmit data empty) */
            [7] = sci_b_uart_tei_isr, /* SCI4 TEI (Transmit end) */
            [8] = sci_b_uart_eri_isr, /* SCI4 ERI (Receive error) */
            ...
            [18] = rm_ethosu_isr, /* NPU IRQ (NPU IRQ) */
        };
        ...
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_NUM_ENTRIES] =
        {
            ...
            [5] = BSP_PRV_VECT_ENUM(EVENT_SCI4_RXI,GROUP5), /* SCI4 RXI (Receive data full) */
            [6] = BSP_PRV_VECT_ENUM(EVENT_SCI4_TXI,GROUP6), /* SCI4 TXI (Transmit data empty) */
            [7] = BSP_PRV_VECT_ENUM(EVENT_SCI4_TEI,GROUP7), /* SCI4 TEI (Transmit end) */
            [8] = BSP_PRV_VECT_ENUM(EVENT_SCI4_ERI,GROUP0), /* SCI4 ERI (Receive error) */
            ...
            [18] = BSP_PRV_VECT_ENUM(EVENT_NPU_IRQ,GROUP2), /* NPU IRQ (NPU IRQ) */
        };
        #endif
        #endif
