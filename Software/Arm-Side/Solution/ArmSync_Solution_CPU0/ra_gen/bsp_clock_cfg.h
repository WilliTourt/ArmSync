...
#define BSP_CFG_PL2ODIVP (BSP_CLOCKS_PLL_DIV_8) /* PLL2P Div /8 */
#define BSP_CFG_PLL2P_FREQUENCY_HZ (300000000) /* PLL2P 300000000Hz */
...
#define BSP_CFG_GPTCLK_DIV (BSP_CLOCKS_GPT_CLOCK_DIV_3) /* GPTCLK Div /3 */
